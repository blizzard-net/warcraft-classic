...
public interface IPvpSeasonApi
{
    ...
    /// </summary>
    /// <param name="pvpRegionId">The ID of the PvP region.</param>
    /// <param name="pvpSeasonId">The ID of the PvP season.</param>
    /// <param name="namespace">The namespace to use to locate this document.</param>
    /// <returns>
    ///     An index of PvP leaderboards for a PvP season.
    /// </returns>
    Task<RequestResult<PvpLeaderboardsIndex>> GetPvpLeaderboardsIndexAsync(int pvpRegionId, int pvpSeasonId, string @namespace);
    ...
    ///     An index of PvP leaderboards for a PvP season.
    /// </returns>
    Task<RequestResult<PvpLeaderboardsIndex>> GetPvpLeaderboardsIndexAsync(int pvpRegionId, int pvpSeasonId, string @namespace, Region region, Locale locale);
    ...
    /// </returns>
    Task<RequestResult<PvpLeaderboard>> GetPvpLeaderboardAsync(int pvpRegionId, int pvpSeasonId, string pvpBracket, string @namespace);
    ...
    ///     The PvP leaderboard of a specific PvP bracket for a PvP season.
    /// </returns>
    Task<RequestResult<PvpLeaderboard>> GetPvpLeaderboardAsync(int pvpRegionId, int pvpSeasonId, string pvpBracket, string @namespace, Region region, Locale locale);
    ...
    /// </returns>
    Task<RequestResult<PvpRewardsIndex>> GetPvpRewardsIndexAsync(int pvpRegionId, int pvpSeasonId, string @namespace);
    ...
    ///     An index of PvP rewards for a PvP season.
    /// </returns>
    Task<RequestResult<PvpRewardsIndex>> GetPvpRewardsIndexAsync(int pvpRegionId, int pvpSeasonId, string @namespace, Region region, Locale locale);
}
