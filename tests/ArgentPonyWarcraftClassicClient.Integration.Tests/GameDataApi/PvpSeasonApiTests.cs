...
public class PvpSeasonApiTests
{
    ...
    public async Task GetPvpSeasonAsync_Gets_PvpSeason()
    {
        ...
        RequestResult<PvpSeason> result = await warcraftClient.GetPvpSeasonAsync(2, "dynamic-classic-us");

        await result.Should().BeSuccessfulRequest()
            .BeEquivalentToBlizzardResponseAsync("https://us.api.blizzard.com/data/wow/pvp-season/2?namespace=dynamic-classic-us&locale=en_US");
    }
    ...
    public async Task GetPvpLeaderboardsIndexAsync_Gets_PvpLeaderboardsIndex()
    {
        ...
        RequestResult<PvpLeaderboardsIndex> result = await warcraftClient.GetPvpLeaderboardsIndexAsync(1, 2, "dynamic-classic-us");

        await result.Should().BeSuccessfulRequest()
            .BeEquivalentToBlizzardResponseAsync("https://us.api.blizzard.com/data/wow/pvp-region/1/pvp-season/2/pvp-leaderboard/index?namespace=dynamic-classic-us&locale=en_US");
    }
    ...
    public async Task GetPvpRewardsIndexAsync_Gets_PvpRewardsIndex()
    {
        ...
        RequestResult<PvpRewardsIndex> result = await warcraftClient.GetPvpRewardsIndexAsync(1, 2, "dynamic-classic-us");

        await result.Should().BeSuccessfulRequest()
            .BeEquivalentToBlizzardResponseAsync("https://us.api.blizzard.com/data/wow/pvp-region/1/pvp-season/2/pvp-reward/index?namespace=dynamic-classic-us&locale=en_US");
    }
}
